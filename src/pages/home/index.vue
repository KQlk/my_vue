<template>
  <v-app id="inspire" cols="12" sm="6" offset-sm="3">
    <v-app-bar
      ...
      dark
      cols="12"
      src="http://reading.ghost.cn/app-bg-02.jpg"
      elevation="24"
      dense
    >
    ...
    >
        ...
        <v-list-item>
          <v-list-item-content>
            <v-list-item-title><span @click="commandHandler('login')">登录</span>
              /
              <span @click="commmandHandler('register')">注册</span></v-list-item-title>
          </v-list-item-content>
        </v-list-item>
      </template>
      ...
      <v-list dense rounded >
        ...
        <v-list-item link @click="commandHandler('abount')">
          <v-list-item-action>
